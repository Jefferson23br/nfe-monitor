-- Versão corrigida: coluna chnfe (minúscula no PostgreSQL)
-- Rodar: sudo -u postgres psql -d nfe_monitor < /root/nfe-monitor/database/001_multi_empresa_corrigido.sql
...
-- Seed opcional com CNPJ fictício (apenas dev/demo). Em produção, cadastre pelo painel
-- ou execute um INSERT privado com seus dados reais (não versionado no Git).
